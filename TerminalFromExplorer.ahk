...
OpenVSDCPInCurrent()
{
    ...
    Run, cmd.exe /K %comspec% /C "C:\Program Files (x86)\Microsoft Visual Studio 14.0\Common7\Tools\VsDevCmd.bat"
...
SetTitleMatchMode, 1
#If (WinActive("ahk_exe WindowsTerminal.exe") && WinActive("Administrator: Windows PowerShell")) || WinActive("Windows PowerShell") || WinActive("Windows PowerShell ISE")
{
    F5::
    {
